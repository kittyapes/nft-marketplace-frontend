...
<div
	class="relative transition min-w-fit {$$props.class}"
...
>
	<button
		class="group text-left text-color-black border-2 border-color-gray-lighter focus-within:border-[#1d1d1d] h-full min-h-[3rem] rounded-md pl-4 pr-2 w-full outline-none clickable flex items-center gap-2 transition-colors"
