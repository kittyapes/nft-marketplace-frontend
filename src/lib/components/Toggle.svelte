...
<label class="btn relative block w-[4.5rem] h-6 border border-black rounded-full scale-[99%] select-none {style.pill}">
	...
	<div
		class="absolute w-6 h-6 bg-[#388DFC] rounded-full top-0 bottom-0 my-auto transition-all duration-300
