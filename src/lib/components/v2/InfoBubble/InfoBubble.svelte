...
<div class="bg-white custom-shadow font-bold p-3 pr-4 rounded-xl max-w-md" on:pointerenter on:pointerleave out:fade|local={{ duration: 100, delay: 200 }}>
	<div class="relative text-color-gray-base" class:text-gradient={gradientText}>
		<!-- Wedge -->
