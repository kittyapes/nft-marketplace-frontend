...
<div id="grid-container" class="grid h-full py-2 overflow-auto font-semibold bg-white border border-gray-300 rounded-xl blue-scrollbar" style:--list-length={data.length}>
	<div>Event</div>
	<div>Price</div>
	<div>From</div>
	<div>To</div>
